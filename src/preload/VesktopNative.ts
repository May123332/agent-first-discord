...
import type { AgentInvokeRequest, AgentInvokeResponse } from "agent/service/types";
...
export const VesktopNative = {
    ...
    agent: {
        ...
        invoke: (request: AgentInvokeRequest) =>
            invoke<AgentInvokeResponse>(IpcEvents.AGENT_INVOKE, request)
    },
    commands: {
