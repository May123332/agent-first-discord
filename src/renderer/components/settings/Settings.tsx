...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the Agent First Discord Settings tab. If this issue persists, try to right click the Vesktop tray icon, then click 'Repair Vencord'. And make sure your Vesktop is up to date."
    }
);
